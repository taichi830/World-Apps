    ...
    var body: some View {
        HStack {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text(result.name).font(.system(size: 20))
                Text(result.kind).font(.system(size: 17))
